        ...
        <div className="w-full">
            ...
            >
                ...
                <div className="mt-5 space-y-2">
                    ...
                    <div className="relative">
                        ...
                        <button
                            ...
                            className="text-muted-foreground hover:text-foreground absolute inset-y-0 right-0 flex items-center px-3.5 transition-colors"
                        >
                            {showPassword ? (
                ...
                <button
                    ...
                    className="bg-brand text-brand-foreground hover:bg-brand/90 mt-8 flex h-12 w-full items-center justify-center gap-2 rounded-lg text-base font-bold transition-colors disabled:opacity-60"
                >
                    {submitting && (
