  ...
  return (
    <input
      ...
      className={cn(
        ...
        "aria-invalid:border-destructive aria-invalid:ring-[3px] aria-invalid:ring-destructive/20 aria-invalid:bg-destructive/5 dark:aria-invalid:ring-destructive/40",
        className,
      )}
      {...props}
    />
